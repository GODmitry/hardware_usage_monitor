...
def rounding(key1): #Функция округляет значение переданного ей аргумента в случае если аргумент имеет тип float или вслучае если аргумент является списком, в котором есть элементы типа float
